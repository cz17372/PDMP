...
VRPF_RES_25par500fold = SharedArray{Float64}(50000,5,20)
...
VRPF_RES_10par500fold = SharedArray{Float64}(50000,5,20)
...
VRPF_RES_50par500fold = SharedArray{Float64}(50000,5,20)
...
@sync @distributed for n = 1:20
    BVRPF_RES_55par_500fold[:,:,n] = BlockVRPF.PG(ChangePoint,y,collect(0.0:100.0:1000.0),auxpar=[2.0,1.0],SMCAdaptN=100,SMCN=50,Globalalpha=0.25)
end

VRPF_RES_100par500fold = SharedArray{Float64}(50000,5,20)
